...
function delDocumento( $uuid )
{
    ...
    $.post( _URL_HOME + 'del/categorias/'+$uuid , _data , function(data, textStatus, xhr) {
        /*optional stuff to do after success */
    }, 'json')
    .fail(function(xhr, status, error) {
        Swal.fire({
...
function cargarDoc( uuid )
{
    ...
    $.post( _URL_HOME+'/cargar/categorias/'+uuid, _data , function(data, textStatus, xhr) {
        /*optional stuff to do after success */
    }, 'json')
    .fail(function(xhr, status, error) {
        Swal.fire({
...
function buscar()
{
    ...
    $.ajax({
        url     : `${_URL_NODE3}/api/categorias/buscar`,
        method  : "POST",
