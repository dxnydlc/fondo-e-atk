           ...
           <div class="row">
               <div class="col-lg-5">
                 <div class="form-group">
                   <label>Año</label>
                   <input type="text" class="form-control" value="{{ hito->anio }}">
                 </div>
                 <div class="form-group">
                   <label>Título</label>
                   <input type="text" class="form-control" value="{{ hito->titulo }}">
                 </div>
                 <div class="form-group">
               ...
               <div class="col-lg-5">
                  <div class="form-group">
                    <label for="exampleInputFile">Imagn Relacionada</label>
